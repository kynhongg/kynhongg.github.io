...
console.log(
  "So 10 xuat hien " + (nums.join(" ").split("10").length - 1) + " lan"
);
console.log(
  "So 23 xuat hien " + (nums.join(" ").split("23").length - 1) + " lan"
);
console.log(
  "So 26 xuat hien " + (nums.join(" ").split("26").length - 1) + " lan"
);
//Case 3
const nums2 = [1000, 2000, 1000, 2000, 10000, 22222];

console.log(
  "So 1000 xuat hien " + (nums.join(" ").split("1000").length - 1) + " lan"
);
console.log(
  "So 2000 xuat hien " + (nums.join(" ").split("2000").length - 1) + " lan"
);
console.log(
  "So 10000 xuat hien " + (nums.join(" ").split("10000").length - 1) + " lan"
);
console.log(
  "So 22222 xuat hien " + (nums.join(" ").split("22222").length - 1) + " lan"
);
